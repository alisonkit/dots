...
(let ((colors '((undef     "#ff00ff" "#ff00ff")
      ...
      (faces '(;; default / basic faces
               ...
               (org-done :foreground ,ctp-subtext1)
               (org-ellipsis :inherit font-lock-comment-face)
               (org-footnote :foreground ,ctp-mauve)
               (org-formula :foreground ,ctp-maroon)
               (org-headline-done :inherit font-lock-comment-face :strike-through t)
               (org-hide :foreground ,ctp-crust :background ,ctp-base)
               (org-level-1 :inherit bold :foreground ,ctp-sapphire
                            ,@(when catppuccin-enlarge-headings
                                (list :height catppuccin-height-title-1)))
               (org-level-2 :inherit bold :foreground ,ctp-maroon
                            ,@(when catppuccin-enlarge-headings
                                (list :height catppuccin-height-title-2)))
               (org-level-3 :weight bold :foreground ,ctp-mauve
                            ,@(when catppuccin-enlarge-headings
                                (list :height catppuccin-height-title-3)))
               (org-level-4 :weight bold :foreground ,ctp-sapphire)
               (org-level-5 :weight bold :foreground ,ctp-maroon)
               (org-level-6 :weight bold :foreground ,ctp-mauve)
               (org-level-7 :weight bold :foreground ,ctp-sapphire)
               (org-level-8 :weight bold :foreground ,ctp-maroon)
               (org-level-9 :weight bold :foreground ,ctp-sapphire)
