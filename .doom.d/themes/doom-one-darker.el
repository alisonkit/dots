...
(def-doom-theme doom-one-darker
  "Fork of default Doom Emacs theme by Alison Kit"

  ;; name        default   256           16
  ((bg         '("#21081f" "black"       "black"  ))
